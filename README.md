...
- script _portno_: opens port for upload of scripts
...
Here is a demo of a small script:
```
% First the initialization, this is done once after booting
on init
do
...
You can examine the currently loaded script using the "show script" command. It only displays about 1KB of a script. If you need to see more, use "show script <line_no>" with a higher starting line.
